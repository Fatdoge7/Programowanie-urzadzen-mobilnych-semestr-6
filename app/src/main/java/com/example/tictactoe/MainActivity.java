...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.playerOneLayout.setBackgroundResource(R.drawable.lavender_border);
    }
    ...
    private void performAction(ImageView  imageView, int selectedBoxPosition) {
        ...
        if (playerTurn == 1) {
            ...
            if (checkResults()) {
                ...
                + " Wygrał!", MainActivity.this);
                resultDialog.setCancelable(false);
                resultDialog.show();
            } else if(totalSelectedBoxes == 9) {
                ResultDialog resultDialog = new ResultDialog(MainActivity.this, "Remis", MainActivity.this);
                resultDialog.setCancelable(false);
                resultDialog.show();
            } else {
                changePlayerTurn(2);
    ...
    private void changePlayerTurn(int currentPlayerTurn) {
        ...
        if (playerTurn == 1) {
            ...
            binding.playerTwoLayout.setBackgroundResource(R.drawable.lavender_border);
